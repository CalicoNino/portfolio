...
export const SHIPS = [
  ...
  { name: "Fantasy",     path: "/3d/fantasy_sailing_ship.glb",    maxSpeed: 30, accel: 0.40, turnSpeed: 0.026, desc: "Swift",          rotY: 0,           yOffset:  2, sketchLink: "https://skfb.ly/pJwvH",  author: "omar",        license: "CC BY 4.0" },
